...
export const POST_CHECKS: Checks[] = [
  ...
  }, */
  {
    ...
    toLabel: true,
    check: new RegExp(
      "\\b(?:https?:\\/\\/)?([^.]+\\.)?(?:gofundme\\.com|gofund\\.me|buymeacoffee\\.com|venmo\\.com|cash\\.(?:app|me)|paypal\\.(?:com|me|app)|gogetfunding\\.com|winred\\.com|givesendgo\\.com|chuffed\\.org|memedefensefund\\.com)",
      "i",
    ),
    ignoredDIDs: [
  ...
  },*/
  {
    ...
    toLabel: true,
    check: new RegExp(
      "(\\b(?:https?:\\/\\/)?([^.]+\\.)?(?:x\\.com/libsoftiktok)|(?:daughtersadvocatingrestoration\\.org|jihadwatch\\.org|thenewworld\\.co\\.uk/sonia-sodha-sandie-peggie-and-the-dangers-of-gender-groupthink/))",
      "i",
    ),
  },
  {
