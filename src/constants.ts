...
export const PROFILE_CHECKS: Checks[] = [
  ...
  },
  {
    ...
    toLabel: false,
    check: new RegExp(
      "Verified by (Molly (Shah|Shane)|@mommunism)",
      "i"
    ),
  },
  {
