...
export const HANDLE_CHECKS: Checks[] = [
  ...
  },
  {
    ...
    commentOnly: false,
    check: new RegExp(
      "[0-9]{1,2}((jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)|(j|f|m|a|s|o|n|d))(20)?25\\.bsky\\.social|(didunddkjd|alycemi|alessakiss83|faykatz)\\.bsky\\.social",
      "i",
    ),
  },
  {
