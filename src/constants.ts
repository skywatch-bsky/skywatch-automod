...
export const LINK_SHORTENER = new RegExp(
  "(?:https?:\\/\\/)?([^.]+\\.)?(tinyurl\\.com|bit\\.ly/|goo\\.gl|g\\.co/|ow\\.ly/|shorturl\\.at|t\\.co/|go\\.bsky\\.app|dlvrit\\.com|t\\.co|t\\.me|is\\.gd|v\\.gd)",
  "i",
);
